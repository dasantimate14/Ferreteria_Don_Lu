    ...
    <header>
      ...
      <nav class="main-nav">
        <ul>
          ...
          <li><a href="registro_cliente.jsp">Reporte de ventas</a></li>
          <li><a href="Inventario.jsp">Reporte de inventario</a></li>
          <li><a href="Inventario.jsp">Reporte de reabastecimiento</a></li>
        </ul>
      </nav>
    </header>
    ...
    <main class="main-notifications">
      ...
      <div class="notification">
        ...
        <div class="notification-content">
          ...
          <div class="notification-text">
            Se ha actualizado la plataforma a la versión 2.1.3 con nuevas
            funciones.
          </div>
        </div>
      </div>
      ...
      <div class="notification">
        ...
        <div class="notification-content">
          ...
          <div class="notification-text">
            Tu cuenta fue registrada correctamente. ¡Bienvenido!
          </div>
        </div>
      </div>
      ...
      <div class="notification">
        ...
        <div class="notification-content">
          ...
          <div class="notification-text">
            Faltan datos por completar en tu perfil. Por favor, revisa tu
            información.
          </div>
        </div>
      </div>
