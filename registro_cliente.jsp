...
if ("POST".equalsIgnoreCase(request.getMethod())) { String cli_nombre =
request.getParameter("cli_nombre"); String cli_apellido_paterno =
request.getParameter("cli_apellido_paterno"); String cli_apellido_materno =
request.getParameter("cli_apellido_materno"); String cli_email =
request.getParameter("cli_email"); String cli_direccion =
request.getParameter("cli_direccion"); try {
...
""); PreparedStatement ps = conn.prepareStatement( "INSERT INTO clientes
(nombre, apellido_paterno, apellido_materno, email, direccion) VALUES (?, ?, ?,
?, ?)"); ps.setString(1, cli_nombre); ps.setString(2, cli_apellido_paterno);
ps.setString(3, cli_apellido_materno); ps.setString(4, cli_email);
ps.setString(5, cli_direccion); ps.executeUpdate(); mensaje = "Cliente
registrado exitosamente."; conn.close(); } catch (Exception e) { mensaje =
      ...
      <section class="form-section">
        ...
        <form method="post" action="register-client.jsp" class="form">
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              id="cli_apellido_paterno"
              name="cli_apellido_paterno"
              class="form-input"
              maxlength="100"
              required
            />
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              id="cli_apellido_materno"
              name="cli_apellido_materno"
              class="form-input"
              maxlength="100"
            />
          </div>
